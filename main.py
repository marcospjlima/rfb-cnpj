...
def start(baixar, threads, diretorio_arquivos, database_url):
    ...
    if baixar:
         log.info('Download dos arquivos')
    ...
    log.info('Convertendo banco de dados')
    convert_database = ConvertDatabase(database_url, diretorio_arquivos)

    #log.info('Excluindo as tabelas caso existam')
    convert_database.drop_tables()  # Exclui as tabelas
